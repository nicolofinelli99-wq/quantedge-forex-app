...
const stats = [
  ...
  { num: "3", label: "Strategies published daily*" },
...
export function Hero() {
  return (
    <header className="relative overflow-hidden px-6 pb-24 pt-28 text-center">
      <div className="pointer-events-none absolute left-1/2 top-[-200px] h-[600px] w-[900px] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(0,229,160,0.16),transparent_60%)] blur-3xl" />
      <ParticleBackground />
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        >
          <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-accent shadow-[0_0_8px_#00e5a0]" />
          Live for Forex Majors, Minors &amp; Metals · Desk online 24/5
        </motion.div>
        <motion.h1
        ...
        >
          In-depth, written trading strategies across major &amp; minor currency pairs — full
          reasoning, key levels and risk plan, delivered straight to your private dashboard the
